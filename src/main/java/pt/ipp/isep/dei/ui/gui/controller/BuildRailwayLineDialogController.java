...
public class BuildRailwayLineDialogController implements Initializable {
    ...
    @FXML
    private CheckBox doubleTrackCheckBox;
    @FXML
    private CheckBox electrifiedCheckBox;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        doubleTrackCheckBox.selectedProperty().addListener((observable, oldValue, newValue) -> updateRailwayLineDetails());
        electrifiedCheckBox.selectedProperty().addListener((observable, oldValue, newValue) -> updateRailwayLineDetails());
    }
    ...
    private void updateRailwayLineDetails() {
        ...
        if (selectedFirstStation != null && selectedSecondStation != null) {
            ...
            if (path != null && !path.isEmpty()) {
                ...
                double estimatedCost = controller.calculatePathCost(path, doubleTrackCheckBox.isSelected(), electrifiedCheckBox.isSelected());
    ...
    private void handleBuild() {
        ...
        if (confirmAlert.showAndWait().orElse(ButtonType.CANCEL) == ButtonType.OK) {
            RailwayLine builtLine = controller.buildRailwayLine(selectedFirstStation, selectedSecondStation, doubleTrackCheckBox.isSelected(), electrifiedCheckBox.isSelected());
